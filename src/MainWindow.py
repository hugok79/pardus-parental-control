...
class MainWindow(Adw.ApplicationWindow):
    ...
    def setup_css(self):
        ...
        style.add_provider_for_display(Gdk.Display.get_default(
    ...
    def setup_main_page(self):
        ...
        self.lbl_profile_btn = Gtk.Label(
            label=Profiles.get_current_profile_name())
